...
class FretboardNote extends Component {
  ...
  componentDidUpdate(prevProps) {
    ...
    if (
      this.props.currentScale != prevProps.currentScale ||
      this.props.currentNote != prevProps.currentNote
    ) {
  ...
  render() {
    return (
      <div
        ...
        /*note={this.props.note}*/ class={
          this.props.isActive ? "fretboard-box-green" : "fretboard-box"
        }
      >
